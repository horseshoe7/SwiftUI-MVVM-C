...
@Observable
public class OldCoordinator<Route: Routable>: CoordinatorProtocol {
        ...
        didSet {
            if let sheet {
                ...
                if let oldValue, var child = self.findChild(branchedFrom: AnyRoutable(oldValue)) {
                    ...
                    child.notifyUserInteractiveFinish()
                }
            }
        }
    }
    ...
    public func createChildCoordinator<ChildRoute: Routable>(
        ...
        return self.buildChildCoordinator(
            ...
            defaultFinishValue: defaultFinishValue
                ...
                return OldCoordinator<ChildRoute>(
                    identifier: identifier,
                    initialRoute: initialRoute,
    ...
    public func buildChildCoordinator<ChildRoute: Routable, CoordinatorType: OldCoordinator<ChildRoute>>(
        identifier: String,
        branchedFrom: AnyRoutable,
        initialRoute: ChildRoute,
        presentationStyle: NavigationPresentationType,
        defaultFinishValue: Any? = nil,
        builder: (OldCoordinator<Route>, SharedNavigationPath) -> CoordinatorType
    ) -> CoordinatorType {
...
//extension OldCoordinator: _CoordinatorProtocol {
